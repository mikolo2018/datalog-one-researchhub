...
export default function InstitutionalPage() {
  return <main>
    ...
    <section className="section"><div className="container split"><div className="institution-list"><h2>Available solutions</h2><p><strong>School assessment:</strong> curriculum-based external evaluation and performance reporting.</p><p><strong>Staff development:</strong> Excel, SPSS, Power BI, research methods and responsible AI.</p><p><strong>Organisational research:</strong> surveys, monitoring, evaluation and analytical reporting.</p><p><strong>Dashboards:</strong> practical performance indicators for leadership decisions.</p></div><InstitutionalForm /></div></section>
  </main>;
}
